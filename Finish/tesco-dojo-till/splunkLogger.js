...
const Logger = function Logger(splunk_token, splunk_url) {
  this.url = splunk_url;
  this.token = splunk_token;
  ...
  this.requester = require(this.parsedUrl.protocol.substring(
    0,
    this.parsedUrl.protocol.length - 1
  ));
